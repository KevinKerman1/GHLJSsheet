...
function changeButtonText(addToAutomationButton) {
    if (addToAutomationButton) {
        ...
        addToAutomationButton.addEventListener('click', function() {
            ...
            setTimeout(function() {
                 // Trigger the URL change functionality after delay
                 changeUrl(); // Call the changeUrl function
                ...
                if (node.nodeType === 1) {
                    ...
                    buttons.forEach(button => {
                        if (button.textContent.trim() === "Add to Automation") {
                            ...
                            changeButtonText(button); // Call the modified changeButtonText function
                            ...
                            // URL change will be triggered by the specific "Add to Dialer" button click event after delay
                        }
                    });
                }
            });
